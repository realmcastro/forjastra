...
| **previsão de venda / projeção de demanda** | comprar e escalar com antecedência | `REL` responde sobre o que **já aconteceu**; projeção precisa de critério de aceite sobre erro aceitável, que eu não sei escrever, e projeção errada apresentada com a mesma autoridade do fato é pior que nenhuma | candidato; precisa de aceite antes de existir |
